...
export default function CVPageClient({ content }: CVPageClientProps) {
  const [activeSection, setActiveSection] = useState("about")
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false)

  const sections = {
    about: <CVAbout content={content.about} />,
    education: <CVEducation content={content.education} />,
    skills: <CVSkills content={content.skills} />,
    experience: <CVExperience content={content.experience} />,
    projects: <CVProjects content={content.projects} />,
  }
    ...
    <div className="min-h-screen bg-gradient-shift relative" suppressHydrationWarning>
      ...
      <div className="flex min-h-screen">
        ...
        <main className="flex-1 min-w-0 flex flex-col">
          <CVHeader content={content.header} />
          ...
          <CVFooter content={content.footer} />
        </main>
      </div>
    </div>
  )
